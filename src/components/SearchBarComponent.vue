<template>
  <div class="relative">
    ...
    >
      <span
        class="bg-purple-400 rounded-lg px-2 py-1 text-xs font-semibold text-gray-950"
      >
    ...
    >
      ...
      <div class="p-3.5 rounded-b-2xl bg-gray-900">
        <button
          type="button"
          @click="onSubmit()"
          class="w-full rounded-xl bg-purple-400 text-gray-900 px-1.5 py-3 text-center text-sm font-semibold hover:bg-purple-300 transition-all duration-300"
        >
