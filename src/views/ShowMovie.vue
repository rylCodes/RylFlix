<template>
  <div class="w-full min-h-svh mb-16">
    ...
    >
      ...
      >
        <h5
          class="text-center font-semibold hover:bg-violet-500 hover:text-gray-100 px-4 py-2 rounded-t-xl transition-colors duration-300"
        >
          Movie Files
        </h5>
        <ul class="bg-gray-900">
          <li
            class="cursor-pointer py-2 px-4 whitespace-nowrap overflow-x-clip hover:bg-gray-800 border-l border-transparent hover:border-violet-500 hover:text-gray-100 transition-all duration-300"
            @click="onSelectMovie()"
          >
